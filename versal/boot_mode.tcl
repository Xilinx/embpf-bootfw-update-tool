...
#
# Set Versal to SD bootmode using XSDB/XSCT
# Switch to SD boot mode #
#
proc boot_sd { } {
	puts "Switching to SD boot mode"
...
#
# Set Versal to eMMC bootmode using XSDB/XSCT
# Switch to emmc boot mode #
#
proc boot_emmc { } {
	puts "Switching to eMMC boot mode"
...
#
# Set Versal to USB bootmode using XSDB/XSCT
# Switch to usb0 boot mode #
#
proc boot_usb { } {
	puts "Switching to USB boot mode"
